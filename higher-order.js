...
const populations = [8175133, 3792621, 2695598, 2100263];
//Code Here
let totalPopulation = populations.reduce((runningTotal, curElement)=> {return runningTotal + curElement},0);
...
let orderTotals = orders.map(e => {return e.price *(e.tax + 1) }) // Code here
...
let bobsTotal = purchases.reduce((acc, obj)=>{if(obj.owner ==='Bob'){return obj.price + acc} else{return acc}},0)//Code Here
